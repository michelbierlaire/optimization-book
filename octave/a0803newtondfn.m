%> \file
%> Newton's method with finite differences, n variables. Implementation of algorithm 8.3 of \cite Bier06-book
%> 
%> @author Michel Bierlaire
%> @date Sat Apr  5 21:36:02 2014
%> @ingroup Algorithms
...
function solution = a0803newtondfn(obj,x0,tau,eps,maxiter=100)
  xk = x0 ;
  f = feval(obj,xk)  ;
  k = 0 ;
