%> \file
%> Truncated conjugate gradients method  to find an approximation of the trust region subproblem. Implementation of algorithm 12.3 of \cite Bier06-book
%> 
%> @author Michel Bierlaire
%> @date Wed Apr  9 18:16:47 2014
%> @ingroup Algorithms
...
function [step,type] = a1203trunccg(g,H,delta)
  tol = 1.0e-6 ;
  n = size(g,1) ;
  xk = zeros(n,1) ;
  gk = g  ;
