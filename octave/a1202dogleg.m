%> \file
%> Dogleg method to find an approximation of the trust region subproblem. Implementation of algorithm 12.2 of \cite Bier06-book
%> 
%> @author Michel Bierlaire
%> @date Wed Apr  9 17:34:52 2014
%> @ingroup Algorithms
...
%> - type  4: Dogleg
%>
function [dstar,type] = a1202dogleg(g,H,delta)
